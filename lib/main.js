...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield octokit.pulls.create({ owner: context.repo.owner, repo: context.repo.repo, title: 'Sync Fork', head: owner + ':' + originBranch, base: destinationBranch, merge_method: mergeMethod })
                .then((pr) => {
